...
export const UploadMetadata: FC = ({}) => {
  ...
  const uploadImage = async () => {
    ...
    .then(responseData => {
        ...
        const arweaveImageUrl = `https://gateway.pinata.cloud/ipfs/${responseData.IpfsHash}`;
      ...
      <div className='border-t border-gray-200 px-4 py-5 sm:p-0'>
        <div className='py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
          ...
          <div className='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1'>
            <div className='px-4 py-5 bg-black text-white space-y-6 sm:p-6'>
              <Listbox value={selected} onChange={setSelected}>
                {() => (
                  <>
                    <div className="mt-1 relative">
                      <Listbox.Button className="bg-black text-white relative w-full border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                      ...
                      <Transition
                        ...
                        leaveTo="opacity-0"
                      >
                        <Listbox.Options className="absolute z-10 mt-1 w-full bg-black text-white shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
                          {bundlers.map((bundler) => (
                            <Listbox.Option
                              key={bundler.id}
                              className={({ active }) =>
                                classNames(
                                  active ? 'text-white bg-purple-500' : 'white',
          ...
          <div className='mt-1 text-sm text-white sm:mt-0 sm:col-span-1'>
            <div className='px-4 py-5 bg-black text-white space-y-6 sm:p-6'>
              <button
                  ...
                  <div className='space-y-1 text-center'>
                    ...
                    <div className='flex text-sm text-white'>
                      <label
                        ...
                        className='relative cursor-pointer bg-black rounded-md font-medium text-purple-500 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500'>
                    ...
                    {!selectedImage ? null : (
                      <p className='text-sm text-white'>{selectedImage}</p>
                    )}
                  </div>
                </div>
              </div>
